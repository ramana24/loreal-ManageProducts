sap.ui.define([
	...
	return Opa5.extend("ux.lorealproducts.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["ux/lorealproducts/localService/mockserver"], function (mockserver) {
